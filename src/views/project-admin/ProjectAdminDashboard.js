            ...
            {isLoading ? (
              ...
              <>
                <KpiCard
                  ...
                  right={
                    <Link
                      to={`/project-admin/site-management/block-management/${site_id}`}
                      style={{
                        fontSize: 11,
                        color: T.cyan,
                        textDecoration: "none",
                ...
                <KpiCard
                  ...
                  right={
                    <>
                      <Link
                        to={`/project-admin/all-site-cleaning-log/sitewise-cleaning-log/${site_id}/${date}`}
                        style={{
                          fontSize: 11,
                          color: T.cyan,
                          textDecoration: "none",
                      ...
                      <Link
                        to={`/project-admin/all-site-cleaning-log/cleaning-report/${site_id}`}
                        style={{
                          fontSize: 11,
                          color: T.cyan,
                          textDecoration: "none",
