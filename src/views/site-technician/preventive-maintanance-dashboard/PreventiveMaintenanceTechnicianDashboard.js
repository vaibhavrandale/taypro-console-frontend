...
// const PreventiveMaintenanceTechnicianDashboard = () => {
//   const [
//     {
//       error,
...
//           to={`/site-technician/preventive-maintanance-dashboard/view`}
//         >
//           View Sitewise
//         </Link>
//         <Link
//           className="btn btn-sm btn-primary m-1"
//           to={`/site-technician/preventive-maintanance-dashboard/create-pm`}
//         >
//           Create New
//         </Link>
//         <Link
//           className="btn btn-sm btn-secondary m-1 d-flex justify-content-center align-items-center"
//           to={`/site-technician/preventive-maintanance-dashboard/preventive-maintanance-notifications`}
//         >
//           All PM Activity
//           <CIcon icon={cilBell} />
//         </Link>
...
//   to={`/site-technician/preventive-maintanance-dashboard/update/${pm._id}`}
// >
//   Update
// </Link>
//                 </CTableDataCell>
...
// export default PreventiveMaintenanceTechnicianDashboard;
          ...
          <div className="d-flex align-items-center gap-3">
            ...
            <div>
              <div className="d-flex align-items-center gap-2 flex-wrap mb-1">
                ...
                <Link
                  className="btn btn-sm btn-warning m-1"
                  to={`/site-technician/preventive-maintanance-dashboard/update/${record._id}`}
                >
                  Update
                </Link>
              </div>
