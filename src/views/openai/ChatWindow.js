...
//   // 🔥 NEW: stable chatId ref (fixes multiple chat creation)
...
//           chatId: activeChatIdRef.current, // 🔥 FIXED
//         }),
...
//         activeChatIdRef.current = newChatId; // immediate sync
...
//       // remove empty assistant bubble if error
//       setMessages((prev) =>
//         prev.filter(
//           (msg) =>
...
//                       onClick={async () => {
//                         const hindi = await translateToHindi(msg.content);
//                         speak(hindi);
//                       }}
//                       style={{
//                         position: "absolute",
...
//             style={{
//               marginLeft: 8,
//               background: loading ? "#dc2626" : "#2563eb",
//               border: "none",
//               color: "white",
//               padding: "14px",
//               borderRadius: 6,
