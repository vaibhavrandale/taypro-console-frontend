...
// const SitewiseTimer = () => {
//   return <div>SitewiseTimer</div>;
// };

// export default SitewiseTimer;
...
const SitewiseTimer = () => {
  const { site_id: SiteId } = useParams(); // ⬅️ Get site_id from URL
                    ...
                    <CTableRow key={`${siteIndex}-${blockIndex}`}>
                      ...
                      <CTableDataCell style={{ minWidth: "150px" }}>
                        ...
                        <Link
                          ...
                          to={`/${adminroute}/all-clients-dashboard/sitewise-timer/${block.block}/${site.site_id}`}
                        >
                          Update
                        </Link>
                      </CTableDataCell>
