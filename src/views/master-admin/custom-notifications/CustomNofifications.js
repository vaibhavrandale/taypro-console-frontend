              ...
              {role_permissions.map((item) => {
                ...
                return (
                  <div className="my-2 form-check" key={roleName}>
                    ...
                    />
                    <label className="mx-2 form-check-label">{roleName}</label>
                  </div>
                );
              })}
            </div>{" "}
            ...
            {addForm.points.map((point, index) => (
              <div key={index} className="d-flex align-items-center gap-2 mb-2">
                ...
                <CButton
                  ...
                  color="danger"
                  onClick={() => {
                    const points = addForm.points.filter((_, i) => i !== index);
                    setAddForm({ ...addForm, points });
                  }}
                >
                  Remove
              ...
              {role_permissions.map((item, idx) => {
                ...
                return (
                  <div className="form-check my-1 me-3" key={idx}>
                    ...
                    />
                    <label className="form-check-label ms-2">{roleName}</label>
                  </div>
                );
              })}
            </div>
            ...
            {addForm.images.map((img, index) => (
              <div key={index} className="d-flex align-items-center gap-2 mb-2">
                ...
                <CButton
                  ...
                  color="danger"
                  onClick={() => {
                    const images = addForm.images.filter((_, i) => i !== index);
                    setAddForm({ ...addForm, images });
                  }}
                >
                  Remove
