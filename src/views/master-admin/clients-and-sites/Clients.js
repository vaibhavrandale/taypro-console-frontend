...
//     //   return {
//     //     ...state,
//     //     clientData: { ...state.clientData, [action.name]: action.value },
//     //   };
//     // case "SUBMIT_FAIL":
//     //   return {
//     //     ...state,
...
//   const openUpdateModal = async (client) => {
//     console.log(client);
//     setModalVisible(true);
...
//     try {
//       const data = await axios.post("/api/v1/clients", formData, {
//         headers: { Authorization: `Bearer ${authtoken}` },
//       });
//       //   console.log(data);
...
//       dispatch({
//         type: "SUBMIT_FAIL",
//         payload: error.response?.data?.message || "Error adding Client",
//       });
...
//       const response = await axios.put(`/api/v1/clients/${id}`, formData, {
//         headers: { Authorization: `Bearer ${authtoken}` },
//       });
...
//         payload: clientsData.map((client) =>
//           client.id === id ? { ...client, ...formData } : client
//         ),
//       });
...
//           <CModalTitle>
//             Update Client :{" "}
//             <span className="badge bg-success">{client.client_id}</span>
//           </CModalTitle>
//         </CModalHeader>
//         <CModalBody>
//           {selectedItem && (
