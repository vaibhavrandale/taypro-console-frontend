...
//       // Navigate to the first robot inside the `data` array
//       if (
//         updatedData.data &&
//         updatedData.data[0] &&
//         updatedData.data[0].robots
//       ) {
//         updatedData.data[0].robots[0] = {
//           ...updatedData.data[0].robots[0],
...
//                       name="timer1"
//                       value={timerData.data[0].robots[0].timer1}
...
//                       className="form-control"
//                       name="timer1_date"
//                       value={timerData.data[0].robots[0].timer1_date}
//                       onChange={handleChange}
//                     />
//                   </div>
//                 </CCol>
...
//                       className="form-control"
//                       name="timer2"
//                       value={timerData.data[0].robots[0].timer2}
//                       onChange={handleChange}
//                     />
//                   </div>
//                 </CCol>
...
//                       className="form-control"
//                       name="timer2_date"
//                       value={timerData.data[0].robots[0].timer2_date}
//                       onChange={handleChange}
//                     />
//                   </div>
//                 </CCol>
...
//                       className="form-control"
//                       name="timer3"
//                       value={timerData.data[0].robots[0].timer3}
//                       onChange={handleChange}
//                     />
//                   </div>
//                 </CCol>
...
//                       className="form-control"
//                       name="timer3_date"
//                       value={timerData.data[0].robots[0].timer3_date}
//                       onChange={handleChange}
//                     />
//                   </div>
//                 </CCol>
