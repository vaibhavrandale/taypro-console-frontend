...
// /* ─── tiny icon helpers (inline SVG so no extra deps) ─── */
...
//     case "SITES_OK":
//       return { ...state, loadingSites: false, sites: payload };
//     case "SITES_ERR":
//       return { ...state, loadingSites: false, sitesError: payload };
//     case "ROBOTS_REQ":
//       return { ...state, loadingRobots: true, robotsError: "" };
//     case "ROBOTS_OK":
//       return { ...state, loadingRobots: false, robots: payload };
//     case "ROBOTS_ERR":
//       return { ...state, loadingRobots: false, robotsError: payload };
//     case "SUBMIT_REQ":
...
//   //   const [robotNo, setRobotNo] = useState(robot_no);
...
//   const [uploadedFile, setUploadedFile] = useState(null); // fallback file upload
...
//   useEffect(() => {
//     (async () => {
//       dispatch({ type: "SITES_REQ" });
//       try {
//         const { data } = await axios.get("/api/v1/sites", {
//           headers: { Authorization: `Bearer ${authtoken}` },
//         });
//         dispatch({ type: "SITES_OK", payload: data.data });
//       } catch (e) {
//         dispatch({
//           type: "SITES_ERR",
//           payload: e.response?.data?.message || "Failed to load sites",
//         });
...
//     const blob = base64ToBlob(uploadedFile, "image/jpeg");
...
//     }
//   }, [uploadedFile, authtoken]);

//   /* ── submit ── */
//   const handleSubmit = async () => {
//     if (!site_id) return toast.error("Please select a site.");
//     if (!robot_no) return toast.error("Please select a robot.");
//     if (!coords)
//       return toast.error("Location not acquired yet. Tap 'Get Location'.");
...
//           image: uploadedImageUrl, // or handle direct dataUrl upload in backend
//         },
//         { headers: { Authorization: `Bearer ${authtoken}` } },
//       );
...
//       margin: 0,
//     },
//     subheading: { color: "#64748b", fontSize: "0.8rem", marginTop: 4 },
//     label: {
//       color: "#94a3b8",
//       fontSize: "0.75rem",
//       fontWeight: 600,
...
//           </div>
//           <div>
//             <h2 style={styles.heading}>Set Robot Location- {robot_no}</h2>
//             <p style={styles.subheading}>Capture GPS + photo for the robot</p>
//           </div>
//         </div>
...
//             Photo (back camera)
//             <span style={styles.badge(!!photoDataUrl)}>
//               {photoDataUrl ? "captured" : "required"}
//             </span>
//           </label>
...
//           {!cameraOpen && !photoDataUrl && (
//             <>
//               <p style={styles.divider}>— or upload —</p>
//               <div
...
//         >
//           {state.submitting ? <CSpinner size="sm" /> : "Create Robot Location"}
//         </button>
