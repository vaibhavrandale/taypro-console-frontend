...
const reducer = (state, action) => {
  switch (action.type) {
    case "FETCH_CERTIFICATES_REQUEST":
      return { ...state, loadingCertificate: true, certificateError: "" };
  ...
  return (
    <>
      {loadingCertificate ? (
        ...
        <CAlert color="danger">{certificateError}</CAlert>
      ) : certificate ? (
        <div>
            ...
            <div className="doc-body p-2">
              ...
              <div className="doc-header ">
                ...
                <div className="meta-grid  border-top border-end border-bottom">
                  ...
                  <div className="cell value border-bottom">
                    {certificate.doc_no}
                  </div>
              ...
              <div className="info-grid  my-2">
                {[
                  ["PROJECT CODE", certificate.project_code],
                  ["CUSTOMER NAME", certificate.client_name],
                  ["PLANT LOCATION", certificate.site_location],
              ...
              <div className="desc border">
                <span className="bold">SYSTEM OVERVIEW</span> : The solar module
                dry cleaning robot system is designed to efficiently clean and
                maintain solar PV modules. This document ensures all
                commissioning checks are completed.
              </div>
              ...
              <div className="sign-grid">
                {certificate.signatures?.map((item, i) => (
                  <div
                    key={i}
                  ...
                  >
                    ...
                    <div className="sign-line  border-top">
                      Designation :
                      <span className="ms-1">{item.designation}</span>
                    </div>
                  </div>
                ))}
              </div>
