...
const Carousels = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <DocsComponents to="components/carousel/" />
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/carousel">
              <CCarousel>
                <CCarouselItem>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/carousel/#with-controls">
              <CCarousel controls>
                <CCarouselItem>
                  <img className="d-block w-100" src={ReactImg} alt="slide 1" />
                </CCarouselItem>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/carousel/#with-indicators">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/carousel/#crossfade">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/carousel/#dark-variant">
