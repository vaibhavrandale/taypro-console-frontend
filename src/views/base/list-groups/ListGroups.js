...
const ListGroups = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <DocsComponents to="components/list-group/" />
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group/#active-items">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group/#disabled-items">
              <CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group/#links-and-buttons">
              <CListGroup>
                <CListGroupItem as="a" to="#" active>
                  Cras justo odio
                </CListGroupItem>
                <CListGroupItem as="a" to="#">
                ...
                <CListGroupItem as="a" to="#" disabled>
                  Vestibulum at eros
                </CListGroupItem>
              </CListGroup>
            </DocsExample>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group/#flush">
              <CListGroup flush>
                <CListGroupItem>Cras justo odio</CListGroupItem>
                <CListGroupItem>Dapibus ac facilisis in</CListGroupItem>
                <CListGroupItem>Morbi leo risus</CListGroupItem>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group/#contextual-classes">
              <CListGroup>
                <CListGroupItem>Dapibus ac facilisis in</CListGroupItem>
                {[
                  "primary",
            ...
            <DocsExample to="components/list-group/#contextual-classes">
              <CListGroup>
                ...
                {[
                  ...
                  <CListGroupItem as="a" to="#" color={color} key={index}>
                    A simple {color} list group item
                  </CListGroupItem>
                ))}
              </CListGroup>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group/#with-badges">
              <CListGroup>
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <Link to="https://coreui.io/docs/utilities/flex/">
                flexbox utilities
              </Link>
              .
            </p>
            <DocsExample to="components/list-group/#custom-content">
              <CListGroup>
                <CListGroupItem as="a" to="#" active>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/list-group/#checkboxes-and-radios">
              <CListGroup>
                <CListGroupItem>
