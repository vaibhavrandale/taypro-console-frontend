...
const Navs = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <DocsComponents to="components/nav-tabs/" />
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/nav-tabs#base-nav">
              <CNav>
                <CNavItem>
                  <CNavLink to="#" active>
                    Active
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <Link to="https://coreui.io/docs/layout/grid/#horizontal-alignment">
                flexbox utilities
              </Link>
            ...
            <DocsExample to="components/nav-tabs#horizontal-alignment">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/nav-tabs#vertical">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/nav-tabs#tabs">
              <CNav variant="tabs">
                <CNavItem>
                  <CNavLink to="#" active>
                    Active
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/nav-tabs#pills">
              <CNav variant="pills">
                <CNavItem>
                  <CNavLink to="#" active>
                    Active
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/nav-tabs#fill-and-justify">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/nav-tabs#working-with-flex-utilities">
              <CNav
                as="nav"
                variant="pills"
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <DocsExample to="components/nav-tabs#tabs-with-dropdowns">
              <CNav>
                <CNavItem>
                  <CNavLink to="#" active>
                    Active
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <DocsExample to="components/nav-tabs#pills-with-dropdowns">
              <CNav variant="pills">
                <CNavItem>
                  <CNavLink to="#" active>
                    Active
