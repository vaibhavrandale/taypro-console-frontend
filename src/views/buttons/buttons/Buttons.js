...
const Buttons = () => {
  return (
    <CRow>
      <CCol xs={12}>
        <DocsComponents to="components/buttons/" />
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/buttons">
        ...
        <CCard className="mb-4">
          ...
          <CCardBody>
            <p className="text-body-secondary small">
              ...
              <Link to="https://coreui.io/icons/">CoreUI Icons</Link>.
            </p>
            <DocsExample to="components/buttons">
              {["normal", "active", "disabled"].map((state, index) => (
                <CRow className="align-items-center mb-3" key={index}>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/buttons#button-components">
              <CButton as="a" color="primary" to="#" role="button">
                Link
              </CButton>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/buttons#outline-buttons">
              {["normal", "active", "disabled"].map((state, index) => (
                <CRow className="align-items-center mb-3" key={index}>
                  <CCol xs={12} xl={2} className="mb-3 mb-xl-0">
                    {state.charAt(0).toUpperCase() + state.slice(1)}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/buttons#ghost-buttons">
              {["normal", "active", "disabled"].map((state, index) => (
                <CRow className="align-items-center mb-3" key={index}>
                  <CCol xs={12} xl={2} className="mb-3 mb-xl-0">
                    {state.charAt(0).toUpperCase() + state.slice(1)}
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/buttons#sizes">
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <DocsExample to="components/buttons#pill-buttons">
              {[
                "primary",
                "secondary",
                "success",
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            <DocsExample to="components/buttons#square">
              {[
                "primary",
                "secondary",
                "success",
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/buttons#disabled-state">
            ...
            <DocsExample to="components/buttons#disabled-state">
              <CButton as="a" to="#" color="primary" size="lg" disabled>
                Primary link
              </CButton>
              <CButton as="a" to="#" color="secondary" size="lg" disabled>
                Link
              </CButton>
            </DocsExample>
          </CCardBody>
      ...
      <CCol xs={12}>
        <CCard className="mb-4">
          ...
          <CCardBody>
            ...
            <DocsExample to="components/buttons#block-buttons">
