...
import SupplyChainAndLogisitcsModal from "./SupplyChainAndLogisitcsModal";
...
export default function SupplyChainAndLogisitics({
  data,
  last_activity,
  createdAt,
  ...
  const metrics = [
    { key: "total_robots_dispatched", label: "Total Robots Dispatched" },
    {
      key: "total_cost_of_purchase_orders",
      label: "Total Cost of Purchase Orders",
    },
    { key: "total_cost_of_logistics", label: "Total Cost of Logistics" },
    {
      key: "total_cost_of_goods_received",
      label: "Total Cost of Goods Received",
    },
    {
      key: "total_cost_of_material_in_stock",
      label: "Total Cost of Material in Stock",
    },
    { key: "new_vendors_onboarded", label: "New Vendors Onboarded" },
    { key: "total_vendors_onboarded", label: "Total Vendors Onboarded" },
  ];
            ...
            {metrics.map((m) => (
              <CCol key={m.key} xs={12} sm={5} md={4}>
                <motion.div
                  ...
                  className="p-3 bg-gray-900/60 rounded-2xl border border-gray-800 hover:border-amber-500/50 transition-all duration-300"
                >
