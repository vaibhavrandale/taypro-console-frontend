...
export default function Project({
  ...
  const metrics = [
    { key: "new_projects_started", label: "New Projects Started" },
    { key: "projects_completed", label: "Projects Completed" },
    { key: "total_robots_installed_capex", label: "Robots Installed (CAPEX)" },
    { key: "total_robots_installed_opex", label: "Robots Installed (OPEX)" },
    { key: "sites_under_commissioning", label: "Sites Under Commissioning" },
    { key: "installation_efficiency", label: "Installation Efficiency" },
    { key: "average_installation_time", label: "Average Installation Time" },
    { key: "manpower_deployed", label: "Manpower Deployed" },
    { key: "travel_logistics_cost", label: "Travel & Logistics Cost" },
    { key: "total_handovers_completed", label: "Handovers Completed" },
    { key: "snag_list_issues_identified", label: "Snag List Issues" },
    { key: "site_safety_incidents", label: "Site Safety Incidents" },
    {
      key: "customer_training_sessions_conducted",
      label: "Customer Training Sessions",
    },
    {
      key: "total_robots_pending_installation",
      label: "Robots Pending Installation",
    },
    { key: "total_poc_given", label: "Total POCs Given" },
    { key: "ongoing_poc", label: "Ongoing POCs" },
    { key: "pending_poc", label: "Pending POCs" },
  ];
            ...
            {metrics.map((m) => (
              <CCol key={m.key} xs={12} sm={5} md={3}>
                <motion.div
                  ...
                  className="p-4 bg-gray-900/60 rounded-2xl border border-gray-800 hover:border-blue-500/40 transition-all duration-300"
                >
