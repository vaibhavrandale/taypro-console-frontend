...
export default function Account({
  ...
  const metrics = [
    { key: "revenue_from_capex", label: "Revenue from CAPEX" },
    { key: "revenue_from_opex", label: "Revenue from OPEX" },
    { key: "revenue_from_amc", label: "Revenue from AMC" },
    ...
    { key: "cash_bank_balance", label: "Cash & Bank Balance" },
    {
      key: "inventory_raw_finished_goods",
      label: "Inventory (Raw + Finished Goods)",
    },
    { key: "advances_to_vendors", label: "Advances to Vendors" },
    { key: "total_current_assets", label: "Total Current Assets" },
    { key: "short_term_loans_od", label: "Short Term Loans / OD" },
    { key: "outstanding_expenses", label: "Outstanding Expenses" },
    { key: "total_current_liabilities", label: "Total Current Liabilities" },
    { key: "working_capital", label: "Working Capital" },
    { key: "cash_flow_in", label: "Cash Flow In" },
    { key: "cash_flow_out", label: "Cash Flow Out" },
    { key: "cash_flow_overall", label: "Cash Flow Overall" },
  ];
            ...
            {metrics.map((m) => (
              <CCol key={m.key} xs={12} sm={5} md={4}>
                <motion.div
                  ...
                  className="p-4 bg-gray-900/60 rounded-2xl border border-gray-800 hover:border-emerald-500/50 transition-all duration-300"
                >
