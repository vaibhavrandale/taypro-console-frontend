...
export default function Service({
  ...
  const metrics = [
    {
      key: "total_service_calls_received",
      label: "Total Service Calls Received",
    },
    { key: "calls_attended_onsite", label: "Calls Attended Onsite" },
    { key: "response_time_avg_hours", label: "Average Response Time (Hours)" },
    {
      key: "resolution_time_avg_hours",
      label: "Average Resolution Time (Hours)",
    },
    { key: "closed_tickets", label: "Closed Tickets" },
    { key: "pending_tickets", label: "Pending Tickets" },
    {
      key: "preventive_maintenance_completed",
      label: "Preventive Maintenance Completed",
    },
    { key: "breakdown_calls", label: "Breakdown Calls" },
    { key: "repeat_complaints", label: "Repeat Complaints" },
    {
      key: "customer_satisfaction_score",
      label: "Customer Satisfaction Score",
    },
    { key: "spare_parts_consumed", label: "Spare Parts Consumed" },
    { key: "amc_revenue_collected", label: "AMC Revenue Collected" },
    {
      key: "service_engineer_utilization",
      label: "Service Engineer Utilization",
    },
    {
      key: "remote_support_cases_resolved",
      label: "Remote Support Cases Resolved",
    },
    { key: "total_poc_given", label: "Total POC Given" },
    { key: "ongoing_poc", label: "Ongoing POC" },
    { key: "pending_poc", label: "Pending POC" },
  ];
            ...
            {metrics.map((m) => (
              <CCol key={m.key} xs={12} sm={5} md={3}>
                <motion.div
                  ...
                  className="p-4 bg-gray-900/60 rounded-2xl border border-gray-800 hover:border-sky-500/50 transition-all duration-300"
                >
